...
public class inputdatarunframe extends input {
	...
	public inputdatarunframe(String age, String gender, String height, String weight){
	...
	public inputdatarunframe() {
		...
		lblNewLabel_3.setIcon(new ImageIcon(inputdatarunframe.class.getResource("/calorie/img/running.jpg")));
