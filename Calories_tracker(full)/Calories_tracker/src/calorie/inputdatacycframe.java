...
//Class inputdatacycframe melakukan inherit pada attribut dari input SuperClass
public class inputdatacycframe extends input {

	public static int time, h, m, s, distance, icon = 2;
	public static double burned;
	public inputdatacycframe(String age, String gender, String height, String weight){
...
//--------------------------------------------------------------------------------------------------------------------------
	...
	public inputdatacycframe() {
		...
		txtExerciseChosen.setBounds(222, 395, 280, 42);
		...
		JLabel lblDistancemeter = new JLabel("Distance (Meter) :");
		...
		lblNewLabel_3.setBounds(0, -75, 365, 312);
		lblNewLabel_3.setIcon(new ImageIcon(inputdatacycframe.class.getResource("/calorie/img/cycling.jpg")));
